...
comparison_plot <- (plot1 | plot2) +
  plot_annotation(
    ...
    subtitle = "The same penguin data reveals opposite relationships when species is ignored vs. considered",
    caption = "LEFT: Overall positive relationship (longer bills = deeper bills) | RIGHT: Within each species, the relationship is negative (longer bills = shallower bills). This reversal demonstrates how confounding variables can completely change our interpretation of data.",
    theme = theme(
